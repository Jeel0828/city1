      ...
      >
        <div className="max-w-7xl container mx-auto px-4 lg:px-20">
          <div className="flex items-center justify-between h-15">
            <img src={logo.src} alt="City1 Developers - Premium Residential Projects" className="h-10" />
            <button
      ...
      >
        ...
        <div className="absolute inset-0">
          ...
          <img
            ...
            alt="City1 Premium Residential Project - Modern Luxury Living Spaces"
          ...
          <img
            src={heroImg.src}
            alt="City1 Premium Residential Project - Luxury Apartments with Modern Architecture"
        ...
        {menuOpen && (
          <>
            ...
            >
              ...
              <img src={logo.src} alt="City1 Developers - Premium Residential Projects" className="h-12 mb-14" />
